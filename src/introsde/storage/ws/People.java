...
public interface People {
    ...
    @RequestWrapper(localName = "deletePersonMeasurementActivities", targetNamespace = "http://ws.storage.introsde/", className = "introsde.storage.ws.DeletePersonMeasurementActivities")
    @ResponseWrapper(localName = "deletePersonMeasurementActivitiesResponse", targetNamespace = "http://ws.storage.introsde/", className = "introsde.storage.ws.DeletePersonMeasurementActivitiesResponse")
    @Action(input = "http://ws.storage.introsde/People/deletePersonMeasurementActivitiesRequest", output = "http://ws.storage.introsde/People/deletePersonMeasurementActivitiesResponse")
    public Boolean deletePersonMeasurementActivities(
        @WebParam(name = "personId", targetNamespace = "")
        Long personId);
    ...
    @WebMethod
    @WebResult(name = "boolean", targetNamespace = "")
    @RequestWrapper(localName = "deletePersonLifeStatusActivities", targetNamespace = "http://ws.storage.introsde/", className = "introsde.storage.ws.DeletePersonLifeStatusActivities")
    @ResponseWrapper(localName = "deletePersonLifeStatusActivitiesResponse", targetNamespace = "http://ws.storage.introsde/", className = "introsde.storage.ws.DeletePersonLifeStatusActivitiesResponse")
    @Action(input = "http://ws.storage.introsde/People/deletePersonLifeStatusActivitiesRequest", output = "http://ws.storage.introsde/People/deletePersonLifeStatusActivitiesResponse")
    public Boolean deletePersonLifeStatusActivities(
        @WebParam(name = "personId", targetNamespace = "")
        Long personId);
